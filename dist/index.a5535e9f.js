...
})({"eK7Px":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
},{"./copyPassword":"kFtGL","./getGeneratedPassword":"bo8JY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kFtGL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
copyButton.addEventListener("click", async ()=>{
    ...
    try {
        ...
        _alertDefault.default('Password copied to clipboard');
    } catch (err) {
        console.log('Failed to copy: ', copy);
    }
});

},{"./alert":"9ePSj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ePSj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _removeOnAnimationsCompleted = require("./utils/removeOnAnimationsCompleted");
var _removeOnAnimationsCompletedDefault = parcelHelpers.interopDefault(_removeOnAnimationsCompleted);
...
const removeAlert = ()=>{
    ...
    _removeOnAnimationsCompletedDefault.default(alert);
};
exports.default = showAlert;

},{"./utils/removeOnAnimationsCompleted":"bi6DQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bi6DQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const removeOnAnimationsCompleted = (elem)=>{
    Promise.all(elem.getAnimations().map(function(animation) {
        return animation.finished;
    })).then(function() {
        return elem.remove();
    });
};
exports.default = removeOnAnimationsCompleted;
